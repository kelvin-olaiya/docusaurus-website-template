...
const config: Config = {
  ...
  baseUrl: '/docusaurus-website-template/',

  // GitHub pages deployment config.
  // If you aren't using GitHub pages, you don't need these.
  organizationName: 'Kelvin Olaiya', // Usually your GitHub org/user name.
  projectName: 'docusaurus-website-template', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/kelvin-olaiya/docusaurus-website-template',
          label: 'GitHub',
          position: 'right',
        },
      ],
